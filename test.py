...
#---------------------------------- MENU START HERE -----------------------------#
def help():
    messagebox.showinfo("Help","Insert tickers, and click submit.\nPlease pay attention to the years")
...
# entry1.bind("<Button-1>", delete)

label2 = Label(root, text="2").grid(row=row_4+1)
entry2 = AutocompleteEntry(lista, root, text="")
entry2.grid(row=row_4+1, column=1)
# entry2.insert(END,'F')
# entry2.bind("<Button-1>", delete)

label3 = Label(root, text="").grid(row=row_4+2)
label3 = Label(root, text="").grid(row=row_4+3)
label3 = Label(root, text="").grid(row=row_4+4)
label3 = Label(root, text="").grid(row=row_4+5)
label3 = Label(root, text="").grid(row=row_4+6)
label3 = Label(root, text="").grid(row=row_4+7)
label3 = Label(root, text="").grid(row=row_4+8)
label3 = Label(root, text="").grid(row=row_4+9)
...
def addBox():
    ...
    print ("add")
    print(row-11)
    Label(root, text=row-11).grid(row=row-8)
    ent_extra = AutocompleteEntry(lista, root, text="")
    ent_extra.grid(row=row-8, column=1)
...
btn_add = Button(root, text="Add more +", command=addBox )
...
popupMenu.grid(row = 1, column =0, sticky=W, ipadx=0, pady=5,columnspan=2)
...
popupMenu.grid(row = 1, column =1, sticky=E, ipadx=0, pady=5,columnspan=2)
...
# ---- Restart AND ￿￿Save Image Buttons ---- #
